...
Inter annotator agreement is used to measure how well multiple annotators can make the same annotation decision for a certain label or class.
anslation when input sentence is splitted into tokens and the tokens converted to desired language and then sentence is combined again
